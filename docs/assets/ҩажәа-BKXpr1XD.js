import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as a}from"./client-misc-DWH6r4ST.js";/* empty css              */import{d as N,P as L,Q as k}from"./path-shape-d9K0Htb1.js";import{d as $,m as D}from"./utility-CxYprhq3.js";import{m as E}from"./misc-37UFysM4.js";import{l as U}from"./math-to-path-i33adzCw.js";import{f as j,c as Y}from"./hershey-fonts-Ds9T3qxh.js";import{s as K,a as X,c as _,t as W}from"./fourier-shared-Cv6d3pfz.js";import{s as J}from"./fourier-samples-X-EaDSNI.js";import"./misc-BtlbED_5.js";import"./letters-base-Bwug51Eg.js";const y={input(n){if(!Number.isSafeInteger(n)||n<0)throw new RangeError(`invalid ${n}`);if(n>=v.length)throw new H(n);return v[n]},ease(n){return(1-Math.cos(Math.PI*n))/2},makeTSplitter:D,makeTSplitterA:$,lerpPoints:U,lerp:E.lerp,makeLinear:E.makeLinear,random:n=>{if(typeof n!="string")throw new RangeError("Invalid seed.  Expecting a string.");return E.Random.fromString(n)},referencePath:new N,samples:J,cursiveLetters:Y,futuraLLetters:j,sampleCount:200,maxKeyframes:10},R=a.getById("go",HTMLButtonElement),A=a.getById("source",HTMLTextAreaElement),S=a.getById("sampleCode",HTMLSelectElement),C=[{name:"Custom",code:""},{name:"Polygons and Stars",code:`const numberOfPoints = 5;
/**
 * 0 to make a polygon.
...
const y = ySum;
return {x, y};}`}];function B(n,t){const o=n.getBBox(),s=t.viewBox.baseVal;s.x=o.x,s.y=o.y,s.width=o.width,s.height=o.height;const l=o.width/o.height,c=300,u=c*l;t.style.height=c+"px",t.style.width=u+"px";const r=Math.max(s.width,s.height)/100;return t.style.setProperty("--recommended-stroke-width",r.toString()),{recommendedStrokeWidth:r}}class Q{static#e=new this;#n=a.getById("distanceVsT",SVGSVGElement);#t=a.querySelector("circle[data-distance]",SVGCircleElement,this.#n);#o=a.querySelector("path",SVGPathElement,this.#n);#s=a.querySelector("circle[data-t]",SVGCircleElement);constructor(){new a.AnimationLoop(t=>{if(this.#t.style.display="none",this.#s.style.display="none",this.f){t%=5e3;const s=t/5e3,l=s*100;this.#t.style.offsetDistance=l+"%",this.#t.style.display="";const{x:c,y:u}=this.f(s);this.#s.cx.baseVal.value=c,this.#s.cy.baseVal.value=u,this.#s.style.display=""}})}f;update(t,o){this.#o.setAttribute("d",o),B(this.#o,this.#n),this.f=t,this.#t.style.offsetPath=L.cssifyPath(o)}static update(t,o){this.#e.update(t,o)}}class z{static#e=new this;#n=a.getById("requestedVsReconstructed",SVGSVGElement);#t;#o;#s=a.querySelector("[data-using] [data-circles]",HTMLTableCellElement);#a=a.querySelector("[data-using] [data-amplitude]",HTMLTableCellElement);#l=a.querySelector("[data-adding] [data-circles]",HTMLTableCellElement);#r=a.querySelector("[data-adding] [data-amplitude]",HTMLTableCellElement);#u=a.querySelector("[data-available] [data-circles]",HTMLTableCellElement);#i=a.querySelector("[data-available] [data-amplitude]",HTMLTableCellElement);constructor(){[this.#t,...this.#o]=a.querySelectorAll("path",SVGPathElement,2,1/0,this.#n)}#c;update(t,o){this.#c?.();const s=[];this.#c=()=>{s.forEach(i=>i.cancel())},this.#t.setAttribute("d",o),B(this.#t,this.#n);const l=K(X(t)),c=_({pauseTime:750,addTime:500,maxGroupsToDisplay:y.maxKeyframes,terms:l,skipCountAtEnd:0}),u=50/c.at(-1).startTime,r={duration:c.at(-1).endTime*3,iterations:1/0};this.#o.forEach((i,h)=>{let p=-1/0,x="";const T=c.map(({offset:b,usingCircles:M})=>{if(M!=p){let P=function(g){if(g.commands.length<2)throw new Error("wtf");const[d,...w]=g.commands,m=w.pop();if(!(d instanceof k&&m instanceof k))throw new Error("wtf");if(d.x0==m.x&&d.y0==m.y)return g;const I=(d.x0+m.x)/2,O=(d.y0+m.y)/2,G=k.controlPoints(I,O,d.x1,d.y1,d.x,d.y),V=k.controlPoints(m.x0,m.y0,m.x1,m.y1,I,O);return new L([G,...w,V])};const e=W(l,M),f=L.parametric(e,y.sampleCount+h);x=P(f).cssPath,p=M}return{offset:b,d:x,easing:"ease-in-out"}});s.push(i.animate(T,r))});{const i=(h,p,x)=>{const T=e=>`'${e.toString().padStart(4,E.FIGURE_SPACE)}'`;let b;const M=new Array;x.forEach(({offset:e,circles:f})=>{b!==void 0&&M.push({offset:e,content:b});const g=b=T(f);M.push({offset:e,content:g})}),s.push(h.animate(M,{pseudoElement:"::after",...r}));const P=x.flatMap(({offset:e,circles:f},g,d)=>{function w(I=f){return I==0?.25:1}if(e==0||e==1)return[{offset:e,opacity:w()}];const m=d[g-1].circles;return m==f?[]:[{offset:e-u,opacity:w(m)},{offset:e,opacity:0},{offset:e+u,opacity:w()}]});[h,p].forEach(e=>s.push(e.animate(P,r)))};i(this.#s,this.#a,c.map(({offset:h,usingCircles:p})=>({offset:h,circles:p}))),i(this.#l,this.#r,c.map(({offset:h,addingCircles:p})=>({offset:h,circles:p}))),i(this.#u,this.#i,c.map(({offset:h,availableCircles:p})=>({offset:h,circles:p})))}{let i=function(e){let f;const g=new Array;return c.forEach(d=>{const{offset:w}=d,m=e(d);f!==void 0&&g.push({offset:w,content:f});const I=f=p(m);g.push({offset:w,content:I})}),g};const h=new Intl.NumberFormat("en-US",{minimumSignificantDigits:5,maximumSignificantDigits:5,useGrouping:!1}).format,p=e=>(e<0&&(e=0),h(e)),x=i(e=>e.usingAmplitude),T=i(e=>e.addingAmplitude),b=i(e=>e.availableAmplitude),M=[...x,...T,...b];let P=0;M.forEach(e=>{const[,f,g]=/^([0-9]+)\.([0-9]+)$/.exec(e.content);switch(f.length){case 3:break;case 2:{e.content=E.FIGURE_SPACE+e.content;break}case 1:{e.content=E.FIGURE_SPACE+E.FIGURE_SPACE+e.content;break}default:throw console.warn({beforeDecimalPoint:f,afterDecimalPoint:g,keyframe:e}),new Error("wtf")}P=Math.max(P,e.content.length)}),M.forEach(e=>{e.content=`'${(e.content+"%").padEnd(P+1,E.FIGURE_SPACE)}'`}),s.push(this.#a.animate(x,{pseudoElement:"::after",...r})),s.push(this.#r.animate(T,{pseudoElement:"::after",...r})),s.push(this.#i.animate(b,{pseudoElement:"::after",...r}))}}static update(t,o){this.#e.update(t,o)}}A.addEventListener("input",()=>{R.disabled=!1,C[0].code=A.value,S.selectedIndex=0});S.innerText="";C.forEach((n,t)=>{const o=document.createElement("option");o.innerText=n.name,S.appendChild(o),n.default&&(S.selectedIndex=t,A.value=n.code)});class q{static#e=a.getById("error",HTMLDivElement);static display(t){this.#e.innerText=t}static displayError(t){t instanceof H?this.#e.innerHTML=`Unable to access <code>support.input(${t.requestedIndex})</code>.  Only ${v.length} input sliders currently exist.  <button onclick="addMoreInputs(this,${t.requestedIndex+1})">Add More</button>`:this.display(t.message)}static clear(){this.display("")}}function Z(n){try{return L.parametric(n,y.sampleCount)}catch(t){if(t instanceof Error){q.displayError(t);return}else throw t}}const v=[];class H extends Error{constructor(t){super(`Unable to access support.input(${t}).  Only ${v.length} input sliders currently exist.`),this.requestedIndex=t}}const tt=a.getById("inputs",HTMLDivElement);function F(){R.disabled=!1;const n=v.length,t=.5,o=`<div class="has-slider">
    ...
    </div>`;tt.insertAdjacentHTML("beforeend",o),v.push(t)}window.addMoreInputs=(n,t)=>{for(n.disabled=!0;v.length<t;)F()};a.querySelector("#inputsGroup button",HTMLButtonElement).addEventListener("click",()=>{F()});F();F();{const n=()=>{q.clear();const s=`"use strict";
`+A.value+`
return f;`;let l;try{l=new Function("support",s)}catch(r){if(r instanceof SyntaxError){q.displayError(r);return}else throw r}let c;y.referencePath.clear(),y.sampleCount=200,y.maxKeyframes=10;try{c=l(y)}catch(r){if(r instanceof Error){q.displayError(r);return}else throw r}const u=r=>{const i=c(r,y);if(!(Number.isFinite(i.x)&&Number.isFinite(i.y)))throw new Error(`Invalid result.  Expected {x,y} where x and y are both finite numbers.  Found: ${JSON.stringify(i)} when t=${r}.`);return i};if(y.referencePath.empty){const r=Z(u);if(!r)return;y.referencePath.d=r.rawPath}Q.update(u,y.referencePath.d),z.update(u,y.referencePath.d)};let t=!1;const o=()=>{R.disabled=!0,t||(t=!0,requestAnimationFrame(()=>{t=!1,n()}))};R.addEventListener("click",o),window.copyNewInput=(s,l)=>{v[l]=s.valueAsNumber;const c=E.assertClass(s.parentElement?.lastElementChild,HTMLSpanElement);c.innerText=s.valueAsNumber.toFixed(5),o()};{const s=()=>{const l=C[S.selectedIndex];A.value=l.code,o()};S.addEventListener("change",s),a.getById("nextSample",HTMLButtonElement).addEventListener("click",()=>{S.selectedIndex=(S.selectedIndex+1)%C.length,s()})}{const s=a.getById("codeSamplesHolder",HTMLDivElement),l=a.getById("inputsGroup",HTMLDivElement),c=`<div>
            <div data-description>
              <button class="show-this">Show This</button><span></span>
            </div>
            <pre data-code-snippet></pre></div>`;C.forEach((u,r)=>{if(r>0){s.insertAdjacentHTML("beforeend",c);const i=s.lastElementChild,h=a.querySelector("span",HTMLSpanElement,i);h.innerText=u.name;const p=a.querySelector("pre",HTMLPreElement,i);p.innerText=u.code,a.querySelector("button",HTMLButtonElement,i).addEventListener("click",()=>{A.value=u.code,o(),l.scrollIntoView({behavior:"smooth"})})}})}o()}{const n=a.getById("hide-text",HTMLInputElement);n.addEventListener("click",()=>{n.checked?document.documentElement.dataset.hide="requested":delete document.documentElement.dataset.hide})}
