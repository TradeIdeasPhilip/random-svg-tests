import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as a}from"./client-misc-B8CxQsfg.js";/* empty css              */import{c as N,P as R,Q as L}from"./path-shape-D-vLKZJh.js";import{d as Q,m as $}from"./utility-DH3fWvUB.js";import{m as E}from"./misc-BHUyxQfl.js";import{l as U}from"./math-to-path-DHD-XsCZ.js";import{f as D,c as j}from"./hershey-fonts-CYD8f4NJ.js";import{s as Y,a as K,g as X,t as _,b as W}from"./fourier-samples-DZtHvX-G.js";import"./letters-base-Lx1egdPZ.js";const y={input(n){if(!Number.isSafeInteger(n)||n<0)throw new RangeError(`invalid ${n}`);if(n>=P.length)throw new H(n);return P[n]},ease(n){return(1-Math.cos(Math.PI*n))/2},makeTSplitter:$,makeTSplitterA:Q,lerpPoints:U,lerp:E.lerp,makeLinear:E.makeLinear,random:n=>{if(typeof n!="string")throw new RangeError("Invalid seed.  Expecting a string.");return E.Random.fromString(n)},referencePath:new N,samples:W,cursiveLetters:j,futuraLLetters:D,sampleCount:200,maxKeyframes:10},F=a.getById("go",HTMLButtonElement),S=a.getById("source",HTMLTextAreaElement),v=a.getById("sampleCode",HTMLSelectElement),C=[{name:"Custom",code:""},{name:"Polygons and Stars",code:`const numberOfPoints = 5;
/**
 * 0 to make a polygon.
