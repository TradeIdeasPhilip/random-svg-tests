import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as n}from"./client-misc-B8CxQsfg.js";/* empty css              */import{p as P,P as k}from"./path-shape-D-vLKZJh.js";import{m as S}from"./misc-BHUyxQfl.js";const E=n.getById("go",HTMLButtonElement),M=n.getById("source",HTMLTextAreaElement),A=n.getById("result",HTMLElement),C=n.getById("pathInfo",HTMLDivElement),f=n.getById("sampleCode",HTMLSelectElement),w=[{name:"Custom",code:""},{name:"Simple Ellipse",code:`// The height can be anything convenient to you.
...
const y = ySum;`}];M.addEventListener("input",()=>{E.disabled=!1,w[0].code=M.value,f.selectedIndex=0});f.innerText="";w.forEach((s,e)=>{const t=document.createElement("option");t.innerText=s.name,f.appendChild(t),s.default&&(f.selectedIndex=e,M.value=s.code)});class I{static#e=n.getById("error",HTMLDivElement);static display(e){this.#e.innerText=e}static displayError(e){e instanceof T?this.#e.innerHTML=`Unable to access <code>support.input(${e.requestedIndex})</code>.  Only ${y.length} input sliders currently exist.  <button onclick="addMoreInputs(this,${e.requestedIndex+1})">Add More</button>`:this.display(e.message)}static clear(){this.display("")}}class d{#e;get svgElement(){return this.#e}#t;get pathElement(){return this.#t}constructor(e){this.#e=n.selectorQuery(e,SVGSVGElement),this.#t=n.selectorQuery("path:not([data-skip-auto-fill])",SVGPathElement,this.#e),d.all.add(this)}static all=new Set;#s=NaN;get recommendedWidth(){return this.#s}#n(){const e=this.#t.getBBox(),t=this.#e.viewBox.baseVal;t.x=e.x,t.y=e.y,t.width=e.width,t.height=e.height;const o=e.width/e.height,c=300,h=c*o;this.#e.style.height=c+"px",this.#e.style.width=h+"px",this.#s=Math.max(t.width,t.height)/100,this.#e.style.setProperty("--recommended-width",this.#s.toString())}setPathShape(e){this.#t.setAttribute("d",e.rawPath),this.#n()}static setPathShape(e){this.all.forEach(t=>t.setPathShape(e))}static pathElement(){return S.pickAny(d.all).#t}deAnimate(e=this.#t){e.getAnimations().forEach(t=>t.cancel())}}new d("#filledSample");new d("#outlineSample");class L extends d{constructor(){super("#chasingPathsSample")}setPathShape(e){super.setPathShape(e);const t=this.pathElement,o=1500,c=Date.now()/o%1;this.deAnimate();const h=t.getTotalLength();t.style.strokeDasharray=`0 ${h} ${h} 0`,t.animate([{strokeDashoffset:0},{strokeDashoffset:-2*h}],{iterations:1/0,duration:o,iterationStart:c})}}new L;class B extends d{constructor(){super("#dancingAntsSample")}setPathShape(e){super.setPathShape(e);const t=this.pathElement,o=250;this.deAnimate();const c=t.getTotalLength(),h=Date.now()/o%1,a=4*this.recommendedWidth,i=a*10<c?c/Math.round(c/a):a;t.style.strokeDasharray=`0 ${i}`,t.animate([{strokeDashoffset:0},{strokeDashoffset:-i}],{iterations:1/0,duration:o,iterationStart:h})}}new B;class q extends d{constructor(){super("#tauFollowingPathSample");let e=!0;new n.AnimationLoop(()=>{const t=e?"0 0":"center";this.svgElement.style.offsetAnchor=t,e=!e})}setPathShape(e){super.setPathShape(e),this.svgElement.style.setProperty("--css-path",e.cssPath)}}new q;new d("#textPathSample");class x extends d{static doItSoon(){console.warn("placeholder")}#e;constructor(){super("#clipAndMaskSupport"),this.#e=n.selectorQuery("mask > path",SVGPathElement,this.svgElement);const e=new ResizeObserver(()=>x.doItSoon());[this.#t,this.#s].forEach(t=>{t.decode().then(()=>x.doItSoon()),e.observe(t)}),this.#o.addEventListener("click",()=>{if(this.#a===void 0)throw new Error("wtf");n.download("ParametricPath.svg",this.#a)})}get measurablePath(){return this.pathElement}#t=n.getById("clipPathSample",HTMLImageElement);#s=n.getById("maskSample",HTMLImageElement);#n=n.getById("maskSample2",HTMLImageElement);#a;#o=n.getById("download",HTMLButtonElement);setPathShape(e){super.setPathShape(e);const t=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="${this.svgElement.getAttribute("viewBox")}" preserveAspectRatio="xMidYMid meet"><path d="${e.rawPath}" stroke="red" fill-opacity="0.5" fill="black" stroke-width="${this.recommendedWidth*4}"/></svg>`,c=`url('${`data:image/svg+xml;base64,${btoa(t)}`}')`;this.#n.style.maskImage=c,this.#a=t,this.#o.disabled=!1;const h=this.measurablePath.getBBox(),a=P(h,{x:0,y:0,height:this.#t.clientHeight,width:this.#t.clientWidth},"srcRect fits completely into destRect"),i=e.transform(a);this.#t.style.clipPath=i.cssPath,this.#e.setAttribute("d",i.rawPath);const m=a.a,u=this.recommendedWidth*m*8;this.#e.style.strokeWidth=u.toString();const g=507;this.deAnimate(this.#e);const l=this.#e.getTotalLength(),r=Date.now()/g%1,p=16*this.recommendedWidth*m,b=p*10<l?l/Math.round(l/p):p;this.#e.style.strokeDasharray=`${u} ${b-u}`,this.#e.animate([{strokeDashoffset:0},{strokeDashoffset:-b}],{iterations:1/0,duration:g,iterationStart:r})}}new x;const y=[];class T extends Error{constructor(e){super(`Unable to access support.input(${e}).  Only ${y.length} input sliders currently exist.`),this.requestedIndex=e}}const H={input(s){if(!Number.isSafeInteger(s)||s<0)throw new RangeError(`invalid ${s}`);if(s>=y.length)throw new T(s);return y[s]}},F=n.getById("inputs",HTMLDivElement);function v(){E.disabled=!1;const s=y.length,e=.5,t=`<div class="has-slider">
    ...
    </div>`;F.insertAdjacentHTML("beforeend",t),y.push(e)}window.addMoreInputs=(s,e)=>{for(s.disabled=!0;y.length<e;)v()};n.selectorQuery("#inputsGroup button",HTMLButtonElement).addEventListener("click",()=>{v()});v();v();{const s=n.getById("segmentCountInput",HTMLInputElement),e=()=>{I.clear();const a=`"use strict";
`+M.value+`
return { x, y };`;let i;try{i=new Function("t /* A value between 0 and 1, inclusive. */","support",a)}catch(r){if(r instanceof SyntaxError){I.displayError(r);return}else throw r}const m=r=>{const p=i(r,H);if(!(Number.isFinite(p.x)&&Number.isFinite(p.y)))throw new Error(`Invalid result.  Expected {x,y} where x and y are both finite numbers.  Found: ${JSON.stringify(p)} when t=${r}.`);return p};let u;try{u=k.parametric(m,s.valueAsNumber)}catch(r){if(r instanceof Error){I.displayError(r);return}else throw r}d.setPathShape(u);const g=d.pathElement(),l=g.getBBox();console.log(l),C.innerText=`Path length = ${g.getTotalLength()}.  Bounding box = {top: ${l.y}, left: ${l.x}, height: ${l.height}, width: ${l.width}}`,A.innerText=g.outerHTML};let t=!1;const o=()=>{E.disabled=!0,t||(t=!0,requestAnimationFrame(()=>{t=!1,e()}))};x.doItSoon=o,E.addEventListener("click",o);const c=n.getById("segmentCountSpan",HTMLSpanElement),h=()=>{c.innerText=s.value.padStart(3,S.FIGURE_SPACE)};h(),s.addEventListener("change",()=>{h(),o()}),window.copyNewInput=(a,i)=>{y[i]=a.valueAsNumber;const m=S.assertClass(a.parentElement?.lastElementChild,HTMLSpanElement);m.innerText=a.valueAsNumber.toFixed(5),o()};{const a=()=>{const i=w[f.selectedIndex];M.value=i.code,o()};f.addEventListener("change",a),n.getById("nextSample",HTMLButtonElement).addEventListener("click",()=>{f.selectedIndex=(f.selectedIndex+1)%w.length,a()})}{const a=n.getById("codeSamplesHolder",HTMLDivElement),i=n.getById("segmentCountHolder",HTMLDivElement),m=`<div>
        <div data-description>
          <button class="show-this">Show This</button><span></span>
        </div>
        <pre data-code-snippet></pre></div>`;w.forEach((u,g)=>{if(g>0){a.insertAdjacentHTML("beforeend",m);const l=a.lastElementChild,r=n.selectorQuery("span",HTMLSpanElement,l);r.innerText=u.name;const p=n.selectorQuery("pre",HTMLPreElement,l);p.innerText=u.code,n.selectorQuery("button",HTMLButtonElement,l).addEventListener("click",()=>{M.value=u.code,o(),i.scrollIntoView({behavior:"smooth"})})}})}o()}{const s=n.getById("hide-text",HTMLInputElement);s.addEventListener("click",()=>{s.checked?document.documentElement.dataset.hide="requested":delete document.documentElement.dataset.hide})}{const s=n.getById("smaller-samples",HTMLInputElement);s.addEventListener("click",()=>{s.checked?document.documentElement.dataset.smallerSamples="requested":delete document.documentElement.dataset.smallerSamples})}
