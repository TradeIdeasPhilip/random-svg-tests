import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as M}from"./client-misc-ZHNZ3-cL.js";/* empty css              */import{P as F,Q as k}from"./path-shape-n6EbRjvk.js";import{P as $,d as g,s as U,e as D,m as j,R as Y}from"./utility-D2jUDy1w.js";import{m as v}from"./misc-wGF4FraP.js";import{l as K}from"./math-to-path-BjxPr1Cw.js";import{f as X,c as W}from"./hershey-fonts-DSx6ymIg.js";import{s as _,a as Q,g as J,t as z,b as Z}from"./fourier-shared-Bvu3pFbM.js";import"./letters-base-CyVhau1S.js";const y={input(n){if(!Number.isSafeInteger(n)||n<0)throw new RangeError(`invalid ${n}`);if(n>=T.length)throw new G(n);return T[n]},ease(n){return(1-Math.cos(Math.PI*n))/2},makeTSplitter:j,makeTSplitterA:D,lerpPoints:K,lerp:v.lerp,makeLinear:v.makeLinear,random:n=>{if(typeof n!="string")throw new RangeError("Invalid seed.  Expecting a string.");return Y.fromString(n)},referencePath:new $,samples:Z,cursiveLetters:W,futuraLLetters:X,sampleCount:200,maxKeyframes:10},O=M.getById("go",HTMLButtonElement),C=M.getById("source",HTMLTextAreaElement),P=M.getById("sampleCode",HTMLSelectElement),L=[{name:"Custom",code:""},{name:"Polygons and Stars",code:`const numberOfPoints = 5;
/**
 * 0 to make a polygon.
