import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as a}from"./client-misc-CLX-waVm.js";/* empty css              */import{d as N,P as L,Q as k}from"./path-shape-niWGxZCK.js";import{d as $,m as D}from"./utility-BqqqUZLU.js";import{m as E}from"./misc-DNuEEHQP.js";import{l as U}from"./math-to-path-52riTG6P.js";import{f as j,c as Y}from"./hershey-fonts-DU7SjD5Q.js";import{s as K,a as X,c as _,t as W}from"./fourier-shared-4IyK7bOl.js";import{s as J}from"./fourier-samples-u3Rw6xgU.js";import"./misc-BWddIZ4y.js";import"./letters-base-C5Px8Lm3.js";const y={input(n){if(!Number.isSafeInteger(n)||n<0)throw new RangeError(`invalid ${n}`);if(n>=v.length)throw new H(n);return v[n]},ease(n){return(1-Math.cos(Math.PI*n))/2},makeTSplitter:D,makeTSplitterA:$,lerpPoints:U,lerp:E.lerp,makeLinear:E.makeLinear,random:n=>{if(typeof n!="string")throw new RangeError("Invalid seed.  Expecting a string.");return E.Random.fromString(n)},referencePath:new N,samples:J,cursiveLetters:Y,futuraLLetters:j,sampleCount:200,maxKeyframes:10},R=a.getById("go",HTMLButtonElement),A=a.getById("source",HTMLTextAreaElement),S=a.getById("sampleCode",HTMLSelectElement),C=[{name:"Custom",code:""},{name:"Polygons and Stars",code:`const numberOfPoints = 5;
/**
 * 0 to make a polygon.
