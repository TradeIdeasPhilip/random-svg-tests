import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as x}from"./client-misc-ZHNZ3-cL.js";/* empty css              */import{P as W}from"./path-shape-fljILaqi.js";import{b as w,s as et}from"./utility-D9E8BDCl.js";import{m as _}from"./misc-wGF4FraP.js";var R,G;function k(){if(G)return R;G=1;var o=function(e,n){return[e[0]+n[0],e[1]+n[1]]},s=function(e,n){return[e[0]-n[0],e[1]-n[1]]},i=function(e,n){return[e[0]*n[0]-e[1]*n[1],e[0]*n[1]+e[1]*n[0]]},t=function(e){return Math.sqrt(e[0]*e[0]+e[1]*e[1])};return R={add:o,subtract:s,multiply:i,magnitude:t},R}var N,U;function V(){if(U)return N;U=1;var o=k(),s={},i=function(n,a){var r=-2*Math.PI*(n/a);return s[a]=s[a]||{},s[a][n]=s[a][n]||[Math.cos(r),Math.sin(r)],s[a][n]},t=function(n){var a=n.map(o.magnitude);return a.slice(0,a.length/2)},e=function(n,a){var r=a/n.length,p=n.slice(0,n.length/2);return p.map(function(l,h){return h*r})};return N={fftMag:t,fftFreq:e,exponent:i},N}var d={},X;function nt(){if(X)return d;X=1;var o=32;d.INT_BITS=o,d.INT_MAX=2147483647,d.INT_MIN=-1<<o-1,d.sign=function(t){return(t>0)-(t<0)},d.abs=function(t){var e=t>>o-1;return(t^e)-e},d.min=function(t,e){return e^(t^e)&-(t<e)},d.max=function(t,e){return t^(t^e)&-(t<e)},d.isPow2=function(t){return!(t&t-1)&&!!t},d.log2=function(t){var e,n;return e=(t>65535)<<4,t>>>=e,n=(t>255)<<3,t>>>=n,e|=n,n=(t>15)<<2,t>>>=n,e|=n,n=(t>3)<<1,t>>>=n,e|=n,e|t>>1},d.log10=function(t){return t>=1e9?9:t>=1e8?8:t>=1e7?7:t>=1e6?6:t>=1e5?5:t>=1e4?4:t>=1e3?3:t>=100?2:t>=10?1:0},d.popCount=function(t){return t=t-(t>>>1&1431655765),t=(t&858993459)+(t>>>2&858993459),(t+(t>>>4)&252645135)*16843009>>>24};function s(t){var e=32;return t&=-t,t&&e--,t&65535&&(e-=16),t&16711935&&(e-=8),t&252645135&&(e-=4),t&858993459&&(e-=2),t&1431655765&&(e-=1),e}d.countTrailingZeros=s,d.nextPow2=function(t){return t+=t===0,--t,t|=t>>>1,t|=t>>>2,t|=t>>>4,t|=t>>>8,t|=t>>>16,t+1},d.prevPow2=function(t){return t|=t>>>1,t|=t>>>2,t|=t>>>4,t|=t>>>8,t|=t>>>16,t-(t>>>1)},d.parity=function(t){return t^=t>>>16,t^=t>>>8,t^=t>>>4,t&=15,27030>>>t&1};var i=new Array(256);return function(t){for(var e=0;e<256;++e){var n=e,a=e,r=7;for(n>>>=1;n;n>>>=1)a<<=1,a|=n&1,--r;t[e]=a<<r&255}}(i),d.reverse=function(t){return i[t&255]<<24|i[t>>>8&255]<<16|i[t>>>16&255]<<8|i[t>>>24&255]},d.interleave2=function(t,e){return t&=65535,t=(t|t<<8)&16711935,t=(t|t<<4)&252645135,t=(t|t<<2)&858993459,t=(t|t<<1)&1431655765,e&=65535,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,t|e<<1},d.deinterleave2=function(t,e){return t=t>>>e&1431655765,t=(t|t>>>1)&858993459,t=(t|t>>>2)&252645135,t=(t|t>>>4)&16711935,t=(t|t>>>16)&65535,t<<16>>16},d.interleave3=function(t,e,n){return t&=1023,t=(t|t<<16)&4278190335,t=(t|t<<8)&251719695,t=(t|t<<4)&3272356035,t=(t|t<<2)&1227133513,e&=1023,e=(e|e<<16)&4278190335,e=(e|e<<8)&251719695,e=(e|e<<4)&3272356035,e=(e|e<<2)&1227133513,t|=e<<1,n&=1023,n=(n|n<<16)&4278190335,n=(n|n<<8)&251719695,n=(n|n<<4)&3272356035,n=(n|n<<2)&1227133513,t|n<<2},d.deinterleave3=function(t,e){return t=t>>>e&1227133513,t=(t|t>>>2)&3272356035,t=(t|t>>>4)&251719695,t=(t|t>>>8)&4278190335,t=(t|t>>>16)&1023,t<<22>>22},d.nextCombination=function(t){var e=t|t-1;return e+1|(~e&-~e)-1>>>s(t)+1},d}var S,D;function $(){if(D)return S;D=1;var o=k(),s=V(),i=nt();return S={fft:function t(e){var n=[],a=e.length;if(a==1)return Array.isArray(e[0])?[[e[0][0],e[0][1]]]:[[e[0],0]];for(var r=t(e.filter(g)),p=t(e.filter(c)),l=0;l<a/2;l++){var h=r[l],f=o.multiply(s.exponent(l,a),p[l]);n[l]=o.add(h,f),n[l+a/2]=o.subtract(h,f)}function g(u,m){return m%2==0}function c(u,m){return m%2==1}return n},fftInPlace:function(t){for(var e=t.length,n=i.countTrailingZeros(e),a=0;a<e;a++){var r=i.reverse(a)>>>i.INT_BITS-n;if(r>a){var p=[t[a],0];t[a]=t[r],t[r]=p}else t[r]=[t[r],0]}for(var l=2;l<=e;l+=l)for(var h=0;h<l/2;h++)for(var f=s.exponent(h,l),g=0;g<e/l;g++){var c=o.multiply(f,t[g*l+h+l/2]);t[g*l+h+l/2]=o.subtract(t[g*l+h],c),t[g*l+h]=o.add(t[g*l+h],c)}}},S}var v,Y;function st(){if(Y)return v;Y=1;var o=$().fft;return v={ifft:function(i){for(var t=[],e=0;e<i.length;e++)t[e]=[i[e][1],i[e][0]];for(var n=o(t),a=[],r=0;r<n.length;r++)a[r]=[n[r][1]/n.length,n[r][0]/n.length];return a}},v}var L,Z;function Q(){if(Z)return L;Z=1;var o=k(),s=V(),i=function(t){for(var e=[],n=t.length,a=0;a<n;a++){e[a]=[0,0];for(var r=0;r<n;r++){var p=s.exponent(a*r,n),l;Array.isArray(t[r])?l=o.multiply(t[r],p):l=o.multiply([t[r],0],p),e[a]=o.add(e[a],l)}}return e};return L=i,L}var B,J;function at(){if(J)return B;J=1;var o=Q();function s(i){for(var t=[],e=0;e<i.length;e++)t[e]=[i[e][1],i[e][0]];for(var n=o(t),a=[],r=0;r<n.length;r++)a[r]=[n[r][1]/n.length,n[r][0]/n.length];return a}return B=s,B}var O,j;function ot(){return j||(j=1,O={fft:$().fft,ifft:st().ifft,fftInPlace:$().fftInPlace,util:V(),dft:Q(),idft:at()}),O}var it=ot();function rt(o,s=1024){if(Math.log2(s)%1!==0)throw new Error("numSamples must be a power of 2");const i=[];for(let n=0;n<s;n++){const a=n/s,r=o(a);i.push([r.x,r.y])}const t=it.fft(i),e=[];for(let n=0;n<s;n++){const[a,r]=t[n],p=Math.sqrt(a*a+r*r)/s,l=Math.atan2(r,a),h=n<=s/2?n:n-s;e.push({frequency:h,amplitude:p,phase:l})}return e.sort((n,a)=>a.amplitude-n.amplitude),e}function lt(o,s){return i=>{let t=0,e=0;for(let n=0;n<Math.min(s,o.length);n++){const{frequency:a,amplitude:r,phase:p}=o[n],l=2*Math.PI*a*i+p;t+=r*Math.cos(l),e+=r*Math.sin(l)}return{x:t,y:e}}}function ct(o){let s=0;o.forEach(n=>s+=n.amplitude);const i=s/1e7,t=o.filter(n=>n.amplitude>i);let e=0;return t.forEach(n=>e+=n.amplitude),console.log(`Removed ${o.length-t.length} of ${o.length} leaving ${t.length} terms.`),console.log(`Removed ${s-e} of ${s} leaving ${e} amplitude.`),t}const A=x.getById("go",HTMLButtonElement),I=x.getById("source",HTMLTextAreaElement),F=x.getById("sampleCode",HTMLSelectElement),C=x.getById("segmentCountInput",HTMLInputElement),q=[{name:"Custom",code:""},{name:"Square",default:!0,code:`if (t < 0.25) {
...
const y = ySum;`}];function K(o,s){const i=o.getBBox(),t=s.viewBox.baseVal;t.x=i.x,t.y=i.y,t.width=i.width,t.height=i.height;const e=i.width/i.height,n=300,a=n*e;s.style.height=n+"px",s.style.width=a+"px";const r=Math.max(t.width,t.height)/100;return s.style.setProperty("--recommended-stroke-width",r.toString()),{recommendedStrokeWidth:r}}class ut{static#e=new this;#n=x.getById("distanceVsT",SVGSVGElement);#t=w("circle[data-distance]",SVGCircleElement,this.#n);#a=w("path",SVGPathElement,this.#n);#s=w("circle[data-t]",SVGCircleElement);constructor(){new x.AnimationLoop(s=>{if(this.#t.style.display="none",this.#s.style.display="none",this.f){s%=5e3;const t=s/5e3,e=t*100;this.#t.style.offsetDistance=e+"%",this.#t.style.display="";const{x:n,y:a}=this.f(t);this.#s.cx.baseVal.value=n,this.#s.cy.baseVal.value=a,this.#s.style.display=""}})}f;update(s,i){this.#a.setAttribute("d",i.rawPath),K(this.#a,this.#n),this.f=s,this.#t.style.offsetPath=i.cssPath}static update(s,i){this.#e.update(s,i)}}class dt{static#e=new this;#n=x.getById("requestedVsReconstructed",SVGSVGElement);#t;#a;#s=w("[data-using] [data-circles]",HTMLTableCellElement);#i=w("[data-using] [data-amplitude]",HTMLTableCellElement);#r=w("[data-adding] [data-circles]",HTMLTableCellElement);#l=w("[data-adding] [data-amplitude]",HTMLTableCellElement);#c=w("[data-available] [data-circles]",HTMLTableCellElement);#u=w("[data-available] [data-amplitude]",HTMLTableCellElement);constructor(){[this.#t,this.#a]=et("path",SVGPathElement,2,2,this.#n)}#o;update(s,i){this.#o?.();const t=[];this.#o=()=>{t.forEach(c=>c.cancel())},this.#t.setAttribute("d",i.rawPath),K(this.#t,this.#n);const e=rt(s),n=ct(e);console.log({originalTerms:e,nonZeroTerms:n}),window.nonZeroTerms=n,window.originalTerms=e;let a=0;n.forEach(c=>a+=c.amplitude);const r=10;let p=0;const l=500,h=250,f=n.slice(0,r-1).flatMap((c,u)=>{const m=c.amplitude/a*100,M={offset:NaN,startTime:NaN,endTime:NaN,usingCircles:u,usingAmplitude:p,addingCircles:1,addingAmplitude:m};p+=m;const y={offset:NaN,startTime:NaN,endTime:NaN,usingCircles:u+1,usingAmplitude:p,addingCircles:0,addingAmplitude:0};return u==0?[y]:[M,y]});{const c=f.at(-1),u=n.length-c.usingCircles;u>0&&f.push({offset:NaN,startTime:NaN,endTime:NaN,usingCircles:c.usingCircles,usingAmplitude:c.usingAmplitude,addingCircles:u,addingAmplitude:100-c.usingAmplitude},{offset:NaN,startTime:NaN,endTime:NaN,usingCircles:n.length,usingAmplitude:100,addingCircles:0,addingAmplitude:0})}{let c=0;f.forEach(u=>{const m=u.addingCircles?h:l,M=c+m;u.startTime=c,u.endTime=M,c=M}),f.forEach(u=>{u.offset=u.startTime/c})}console.log(f);const g={duration:f.at(-1).endTime*5,iterations:1/0};{let c=-1/0,u="";const m=f.map(({offset:M,usingCircles:y})=>{if(y!=c){const b=lt(n,y);u=W.parametric(b,C.valueAsNumber).cssPath,c=y}return{offset:M,d:u,easing:"ease-in-out"}});t.push(this.#a.animate(m,g))}{const c=f.map(({offset:u,usingCircles:m})=>{const M=`'${m}'`;return{offset:u,content:M}});console.log(c),t.push(this.#s.animate(c,{pseudoElement:"::after",...g}))}{const c=f.map(({offset:u,addingCircles:m})=>{const M=`'${m}'`;return{offset:u,content:M}});console.log(c),t.push(this.#r.animate(c,{pseudoElement:"::after",...g}))}{const c=f.map(({offset:u,usingCircles:m,addingCircles:M})=>{const y=`'${n.length-m-M}'`;return{offset:u,content:y}});console.log(c),t.push(this.#c.animate(c,{pseudoElement:"::after",...g}))}{const c=new Intl.NumberFormat("en-US",{minimumSignificantDigits:5,maximumSignificantDigits:5,useGrouping:!1}).format,u=f.map(({offset:y,usingAmplitude:b})=>{const E=`'${c(b)}'`;return{offset:y,content:E}});t.push(this.#i.animate(u,{pseudoElement:"::after",...g}));const m=f.map(({offset:y,addingAmplitude:b})=>{const E=`'${c(b)}'`;return{offset:y,content:E}});t.push(this.#l.animate(m,{pseudoElement:"::after",...g}));const M=f.map(({offset:y,usingAmplitude:b,addingAmplitude:E})=>{const tt=`'${c(100-b-E)}'`;return{offset:y,content:tt}});t.push(this.#u.animate(M,{pseudoElement:"::after",...g}))}console.log(t)}static update(s,i){this.#e.update(s,i)}}I.addEventListener("input",()=>{A.disabled=!1,q[0].code=I.value,F.selectedIndex=0});F.innerText="";q.forEach((o,s)=>{const i=document.createElement("option");i.innerText=o.name,F.appendChild(i),o.default&&(F.selectedIndex=s,I.value=o.code)});class H{static#e=x.getById("error",HTMLDivElement);static display(s){this.#e.innerText=s}static displayError(s){s instanceof z?this.#e.innerHTML=`Unable to access <code>support.input(${s.requestedIndex})</code>.  Only ${T.length} input sliders currently exist.  <button onclick="addMoreInputs(this,${s.requestedIndex+1})">Add More</button>`:this.display(s.message)}static clear(){this.display("")}}function ht(o){try{return W.parametric(o,C.valueAsNumber)}catch(s){if(s instanceof Error){H.displayError(s);return}else throw s}}const T=[];class z extends Error{constructor(s){super(`Unable to access support.input(${s}).  Only ${T.length} input sliders currently exist.`),this.requestedIndex=s}}const pt={input(o){if(!Number.isSafeInteger(o)||o<0)throw new RangeError(`invalid ${o}`);if(o>=T.length)throw new z(o);return T[o]}},ft=x.getById("inputs",HTMLDivElement);function P(){A.disabled=!1;const o=T.length,s=.5,i=`<div class="has-slider">
    ...
    </div>`;ft.insertAdjacentHTML("beforeend",i),T.push(s)}window.addMoreInputs=(o,s)=>{for(o.disabled=!0;T.length<s;)P()};w("#inputsGroup button",HTMLButtonElement).addEventListener("click",()=>{P()});P();P();{const o=()=>{H.clear();const n=`"use strict";
`+I.value+`
return { x, y };`;let a;try{a=new Function("t /* A value between 0 and 1, inclusive. */","support",n)}catch(l){if(l instanceof SyntaxError){H.displayError(l);return}else throw l}const r=l=>{const h=a(l,pt);if(!(Number.isFinite(h.x)&&Number.isFinite(h.y)))throw new Error(`Invalid result.  Expected {x,y} where x and y are both finite numbers.  Found: ${JSON.stringify(h)} when t=${l}.`);return h},p=ht(r);p&&(ut.update(r,p),dt.update(r,p))};let s=!1;const i=()=>{A.disabled=!0,s||(s=!0,requestAnimationFrame(()=>{s=!1,o()}))};A.addEventListener("click",i);const t=x.getById("segmentCountSpan",HTMLSpanElement),e=()=>{t.innerText=C.value.padStart(3,_.FIGURE_SPACE)};e(),C.addEventListener("change",()=>{e(),i()}),window.copyNewInput=(n,a)=>{T[a]=n.valueAsNumber;const r=_.assertClass(n.parentElement?.lastElementChild,HTMLSpanElement);r.innerText=n.valueAsNumber.toFixed(5),i()};{const n=()=>{const a=q[F.selectedIndex];I.value=a.code,i()};F.addEventListener("change",n),x.getById("nextSample",HTMLButtonElement).addEventListener("click",()=>{F.selectedIndex=(F.selectedIndex+1)%q.length,n()})}i()}{const o=x.getById("hide-text",HTMLInputElement);o.addEventListener("click",()=>{o.checked?document.documentElement.dataset.hide="requested":delete document.documentElement.dataset.hide})}
